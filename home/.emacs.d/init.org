...
These are generally put next to their relevant configuration when applicable.
To find, search for ':noweb-ref my-pkg'
...
See also [[*Fold-Dwim-Org%20compatibility%20shim][Fold-Dwim-Org compatibility shim]]
