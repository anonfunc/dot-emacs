...
#+begin_src emacs-lisp
  (setq mu4e-maildir       "~/Maildir"   ;; top-level Maildir
        ...
        mu4e-html2text-command "tr -d '\r¹©' | sed -e s/’/\\'/g -e 's!&nbsp;! !g' -e 's!&gt;!>!g' -e 's!–!-!g' | html2text -width 100 -style pretty")
#+end_src
See also [[http://www.djcbsoftware.nl/code/mu/mu4e/Maildir-searches.html#Maildir-searches][Setting up maildir shortcuts]]
** Bookmarks
#+begin_src emacs-lisp
  (add-to-list 'mu4e-bookmarks
               '("(from:CRT OR from:jira) AND NOT flag:trashed"
                 "Trashable" ?q))

  (add-to-list 'mu4e-bookmarks
               '("(to:ask_tools OR cc:ask_tools) AND maildir:/Archive"
                 "Archive/ask_tools" ?a))

  (add-to-list 'mu4e-bookmarks
               '("rb.corp.workplace.com AND maildir:/Archive"
                 "Archive/Reviews" ?e))
#+end_src
** Sending Mail
#+begin_src emacs-lisp
